                ...
                <div class="container-fluid py-4">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul id="tabs" class="ticket-tab nav nav-tabs">
                                <li class="nav-item">
                                    <a href="" data-target="#open-tickets" data-toggle="tab" class="nav-link small text-uppercase active">Открытые</a></li>
                                <li class="nav-item">
                  ...
                  <i class="fa fa-plus tic-fa" aria-hidden="true"></i>Создать тикет</button>
                                  ...
                                  <span>Дата</span>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="message-info">Message Aliquam sem et tortor consequat id porta nibh
                                  venenatis cras. In hac habitasse platea dictumst</span>
                            ...
                            <div>
                                ...
                                <div class="modal fade" id="exampleModalTickets" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                          ...
                          <i class="fa fa-plus tic-fa" aria-hidden="true"></i>Добавить новый тикет</button>
                            ...
                            <!-- ===== THE END Modal tiket Add ===== -->

                            <!-- ====== Modal - TICKET-INFO  ======= -->

                            <div class="modal fade" id="exampleModalTicketInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Новый тикет</h5>
                                            ...
                                            <div class="content-new-ticket">
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="">
                                                            <span>
                                Aliquam sem et tortor consequat id porta nibh venenatis cras. In hac habitasse platea
                                dictumst vestibulum rhoncus est pellentesque. A arcu cursus vitae congue. Id nibh tortor
                                id aliquet lectus proin nibh. Aenean pharetra magna ac placerat. Dui vivamus arcu felis
                                bibendum ut. Iaculis nunc sed augue lacus viverra vitae congue eu. Curabitur vitae nunc
                                sed velit dignissim sodales. Quis ipsum suspendisse ultrices gravida dictum fusce ut
                                placerat orci. Duis tristique sollicitudin nibh sit amet. Massa enim nec dui nunc. Ipsum
                                nunc aliquet bibendum enim facilisis gravida neque. Ullamcorper eget nulla facilisi
                                etiam dignissim diam quis enim. Feugiat sed lectus vestibulum mattis ullamcorper velit
                                sed ullamcorper. Tellus at urna condimentum mattis pellentesque id. Tincidunt ornare
                                massa eget egestas purus. Fringilla est ullamcorper eget nulla facilisi etiam. Risus
